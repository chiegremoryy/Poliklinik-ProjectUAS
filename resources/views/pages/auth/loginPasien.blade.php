...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="card">
      <div class="card-body">
        <p class="login-box-msg">Welcome back! Please log in to access your patient dashboard.</p>

        <form action="/pages/auth/login" method="post">
          @csrf

          <div class="form-group">
            <label for="nama">Nama Pasien</label>
            <div class="input-group mb-3">
              <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Pasien" required autofocus>
